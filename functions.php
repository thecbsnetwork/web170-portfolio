...
if (function_exists('register_sidebar'))
{
    ...
    // Define Sidebar For About Page
    register_sidebar(array(
        'name' => __('Features Sidebar', 'html5blank'),
        'description' => __('Features Sidebar', 'html5blank'),
        'id' => 'sidebar-features',
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
    ...
    // Define Sidebar For Contact Page
    register_sidebar(array(
        'name' => __('Contact Sidebar', 'html5blank'),
        'description' => __('Contact Sidebar', 'html5blank'),
        'id' => 'contact-blog',
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
...
function html5wp_excerpt($length_callback = '80', $more_callback = '20')
{
    global $post;
